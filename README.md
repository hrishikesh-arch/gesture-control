...
- **Interactive Gestures**: Pinch and move your hand to manipulate the particles, switch templates (Sphere, Saturn, Flower, Fireworks).

## Tech Stack
- JavaScript (Vite)
- Three.js (WebGL rendering)
- MediaPipe / TensorFlow (Hand tracking)
